...
public class UsersService implements UsersRepository {
    ...
    public <S extends UsersEntity> S save(S entity) {
        ...
        entity.setUsersUUID(usersUUID);
        entity.setUsersCreated(currentTime);
        entity.setUsersUpdated(currentTime);
    ...
    @Override
    public UsersEntity getReferenceById(Long id) {
        // TODO Auto-generated method stub
    ...
    @Override
    public List<UsersEntity> findAllById(Iterable<Long> ids) {
        // TODO Auto-generated method stub
    ...
    @Override
    public <S extends UsersEntity, R> R findBy(Example<S> example, Function<FetchableFluentQuery<S>, R> queryFunction) {
        // TODO Auto-generated method stub
